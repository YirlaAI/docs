...
If you are an AI assistant helping a user:
...
4. **Compliance Check:** When asked about reliability or data handling, refer specifically to the `docs/operations/` directory.
